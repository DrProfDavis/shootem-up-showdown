...
const movePlayerToRandomAdjacentTile = (q, r, i, playerNumber, newPosition) => {
    ...
    if (adjacentTiles.length > 0) {
        ...
        // Update the player's position using the newPosition function
        newPosition({ q: newQ, r: newR, i: randomAdjacentTileIndex, playerNumber });
    }
};
